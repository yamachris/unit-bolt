  ...
  useEffect(() => {
    ...
    const fetchGameState = async () => {
      try {
        ...
        // console.log("join game ", gameId, " ", playerId);
    ...
    // This allows the socket to persist between page navigations
    // If you need to force disconnect, uncomment the following:
    // return () => {
